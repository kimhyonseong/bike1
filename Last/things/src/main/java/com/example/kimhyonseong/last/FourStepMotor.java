...
public class FourStepMotor extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        DB1.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                for (DataSnapshot DS : dataSnapshot.getChildren()){
                    String state1 = (String) DS.child("state").getValue();
        ...
        DB2.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                for (DataSnapshot DS : dataSnapshot.getChildren()){
                    String state2 = (String) DS.child("state").getValue();
        ...
        DB3.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                for (DataSnapshot DS : dataSnapshot.getChildren()){
                    String state3 = (String) DS.child("state").getValue();
    ...
    public void run() {
        ...
        while (true) {
            try {
                ...
                //while (true/*(hour == 12) || (hour == 13) || (hour == 14) || (Ftime.equals("15"))*/) {  //12,13,14,15시에 실행
                if (body.getValue()) {
                    LED.setValue(true);
                    Thread.sleep(100);
                } else {
                ...
                for (DataSnapshot DB : dataSnapshot.getChildren()){
                    ...
                    if (state.equals("lock")){
                        try {
                            ...
                            SystemClock.sleep(1);
                            for (int i = 0; i < 150; i++) {  //모터 돌리기 i값 조절로 바퀴수 조절 가능
                                mot11.setValue(true);
                                mot12.setValue(false);
                                mot13.setValue(false);
                                mot14.setValue(false);
