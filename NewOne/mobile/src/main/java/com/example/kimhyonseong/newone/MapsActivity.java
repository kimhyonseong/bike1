        ...
        DB.addValueEventListener(new ValueEventListener() {  //보관소 남은 자리
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                for (DataSnapshot DS : dataSnapshot.getChildren()) {
                    String state1 = (String) DS.child("user1").child("state").getValue();
                    String state2 = (String) DS.child("user2").child("state").getValue();
                    String state3 = (String) DS.child("user3").child("state").getValue();
